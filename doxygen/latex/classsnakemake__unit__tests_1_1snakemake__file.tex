...
unsigned \mbox{\hyperlink{classsnakemake__unit__tests_1_1snakemake__file_a78a2f2c6e4529f15d1ec3dd7aa470dbe}{report\+\_\+single\+\_\+rule}} (const std\+::map$<$ std\+::string, bool $>$ \&rule\+\_\+names, std\+::ostream \&out) const
...
bool \mbox{\hyperlink{classsnakemake__unit__tests_1_1snakemake__file_ac58548d6095bdeba444c7c16a95e0a73}{resolve\+\_\+with\+\_\+python}} (const boost\+::filesystem\+::path \&workspace, const boost\+::filesystem\+::path \&pipeline\+\_\+top\+\_\+dir, const boost\+::filesystem\+::path \&pipeline\+\_\+run\+\_\+dir, bool verbose, bool disable\+\_\+resolution)
...
void \mbox{\hyperlink{classsnakemake__unit__tests_1_1snakemake__file_a337c9312f49886fc34e4e33aa2c0dc10}{report\+\_\+rules}} (std\+::map$<$ std\+::string, std\+::vector$<$ boost\+::shared\+\_\+ptr$<$ \mbox{\hyperlink{classsnakemake__unit__tests_1_1rule__block}{rule\+\_\+block}} $>$$>$$>$ $\ast$aggregated\+\_\+rules) const
\begin{DoxyCompactList}\small\item\em report loaded rules in this file and all dependencies \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classsnakemake__unit__tests_1_1snakemake__file_a75b0c428f80d86e204a9a321258e8153}{query\+\_\+rule\+\_\+checkpoint}} (const std\+::string \&rule\+\_\+name, bool $\ast$target) const
\begin{DoxyCompactList}\small\item\em query rule for whether it\textquotesingle{}s a checkpoint \end{DoxyCompactList}\item 
\mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_aa40068dc50e700e58c6383bf612feb36}\label{classsnakemake__unit__tests_1_1snakemake__file_aa40068dc50e700e58c6383bf612feb36}} 
void \mbox{\hyperlink{classsnakemake__unit__tests_1_1snakemake__file_aa40068dc50e700e58c6383bf612feb36}{aggregate\+\_\+rulesdot}} ()
\begin{DoxyCompactList}\small\item\em collect \textquotesingle{}rules.\textquotesingle{} dependency data for all loaded rules \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classsnakemake__unit__tests_1_1snakemake__file_a04b8a3420b8a4ed256949ad4bf3e2fb6}{recursively\+\_\+query\+\_\+rulesdot}} (const std\+::string \&rule\+\_\+name, std\+::map$<$ std\+::string, bool $>$ $\ast$target) const
\begin{DoxyCompactList}\small\item\em query rule for any \textquotesingle{}rules.\textquotesingle{} references, including those of dependencies pulled in by \textquotesingle{}rules.\textquotesingle{} \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classsnakemake__unit__tests_1_1snakemake__file_af63100961174fdcdf8d930ec115002fe}{get\+\_\+base\+\_\+rule\+\_\+name}} (const std\+::string \&name, std\+::string $\ast$target) const
\begin{DoxyCompactList}\small\item\em for a single rule, get base rule name \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classsnakemake__unit__tests_1_1snakemake__file_a8e6721d0da386435ae7fad2722aeeac4}{get\+\_\+rulesdot}} (const std\+::string \&name, std\+::vector$<$ std\+::string $>$ $\ast$target) const
\begin{DoxyCompactList}\small\item\em for a single rule, get \textquotesingle{}rules.\textquotesingle{} dependencies \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_a9820efb0270a8a37a1ad067d787c41fd}\label{classsnakemake__unit__tests_1_1snakemake__file_a9820efb0270a8a37a1ad067d787c41fd}} 
std\+::map$<$ std\+::string, std\+::vector$<$ std\+::string $>$ $>$ \mbox{\hyperlink{classsnakemake__unit__tests_1_1snakemake__file_a9820efb0270a8a37a1ad067d787c41fd}{\+\_\+rulesdot}}
\begin{DoxyCompactList}\small\item\em report of the \textquotesingle{}rules.\textquotesingle{} dependencies of each rule \end{DoxyCompactList}\item 
...
whether the object\textquotesingle{}s rules are unambiguously resolved
\end{DoxyReturn}
this will involve querying the rules for their own diagnosis of their status. this logic is not yet fully clear to me. \mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_af63100961174fdcdf8d930ec115002fe}\label{classsnakemake__unit__tests_1_1snakemake__file_af63100961174fdcdf8d930ec115002fe}} 
\index{snakemake\_unit\_tests::snakemake\_file@{snakemake\_unit\_tests::snakemake\_file}!get\_base\_rule\_name@{get\_base\_rule\_name}}
\index{get\_base\_rule\_name@{get\_base\_rule\_name}!snakemake\_unit\_tests::snakemake\_file@{snakemake\_unit\_tests::snakemake\_file}}
\doxysubsubsection{\texorpdfstring{get\_base\_rule\_name()}{get\_base\_rule\_name()}}
{\footnotesize\ttfamily bool snakemake\+\_\+unit\+\_\+tests\+::snakemake\+\_\+file\+::get\+\_\+base\+\_\+rule\+\_\+name (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{name,  }\item[{std\+::string $\ast$}]{target }\end{DoxyParamCaption}) const}



for a single rule, get base rule name 


\begin{DoxyParams}{Parameters}
{\em name} & name of rule to query \\
\hline
{\em target} & where to store detected parent, or empty string \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
whether the rule was found 
\end{DoxyReturn}
\mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_a9fde24da88f8f51c78c7cbb5decd5cae}\label{classsnakemake__unit__tests_1_1snakemake__file_a9fde24da88f8f51c78c7cbb5decd5cae}} 
...
\end{DoxyReturn}
\mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_a8e6721d0da386435ae7fad2722aeeac4}\label{classsnakemake__unit__tests_1_1snakemake__file_a8e6721d0da386435ae7fad2722aeeac4}} 
\index{snakemake\_unit\_tests::snakemake\_file@{snakemake\_unit\_tests::snakemake\_file}!get\_rulesdot@{get\_rulesdot}}
\index{get\_rulesdot@{get\_rulesdot}!snakemake\_unit\_tests::snakemake\_file@{snakemake\_unit\_tests::snakemake\_file}}
\doxysubsubsection{\texorpdfstring{get\_rulesdot()}{get\_rulesdot()}}
{\footnotesize\ttfamily bool snakemake\+\_\+unit\+\_\+tests\+::snakemake\+\_\+file\+::get\+\_\+rulesdot (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{name,  }\item[{std\+::vector$<$ std\+::string $>$ $\ast$}]{target }\end{DoxyParamCaption}) const}



for a single rule, get \textquotesingle{}rules.\textquotesingle{} dependencies 


\begin{DoxyParams}{Parameters}
{\em name} & name of rule to query \\
\hline
{\em target} & where to store detected \textquotesingle{}rules.\textquotesingle{} rulenames \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
whether the rule was found 
...
\end{DoxyReturn}
\mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_a353aa10f913ba10ab923dfe4fee63e2f}\label{classsnakemake__unit__tests_1_1snakemake__file_a353aa10f913ba10ab923dfe4fee63e2f}} 
...
\end{DoxyReturn}
this is the recursive entry point for a recursion pass through python reporting. this should be called for each file in turn. \mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_a75b0c428f80d86e204a9a321258e8153}\label{classsnakemake__unit__tests_1_1snakemake__file_a75b0c428f80d86e204a9a321258e8153}} 
\index{snakemake\_unit\_tests::snakemake\_file@{snakemake\_unit\_tests::snakemake\_file}!query\_rule\_checkpoint@{query\_rule\_checkpoint}}
\index{query\_rule\_checkpoint@{query\_rule\_checkpoint}!snakemake\_unit\_tests::snakemake\_file@{snakemake\_unit\_tests::snakemake\_file}}
\doxysubsubsection{\texorpdfstring{query\_rule\_checkpoint()}{query\_rule\_checkpoint()}}
{\footnotesize\ttfamily bool snakemake\+\_\+unit\+\_\+tests\+::snakemake\+\_\+file\+::query\+\_\+rule\+\_\+checkpoint (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{rule\+\_\+name,  }\item[{bool $\ast$}]{target }\end{DoxyParamCaption}) const}



query rule for whether it\textquotesingle{}s a checkpoint 


\begin{DoxyParams}{Parameters}
{\em rule\+\_\+name} & name of rule to query \\
\hline
{\em target} & where to store checkpoint status \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
whether the rule was found 
\end{DoxyReturn}
\mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_a04b8a3420b8a4ed256949ad4bf3e2fb6}\label{classsnakemake__unit__tests_1_1snakemake__file_a04b8a3420b8a4ed256949ad4bf3e2fb6}} 
\index{snakemake\_unit\_tests::snakemake\_file@{snakemake\_unit\_tests::snakemake\_file}!recursively\_query\_rulesdot@{recursively\_query\_rulesdot}}
\index{recursively\_query\_rulesdot@{recursively\_query\_rulesdot}!snakemake\_unit\_tests::snakemake\_file@{snakemake\_unit\_tests::snakemake\_file}}
\doxysubsubsection{\texorpdfstring{recursively\_query\_rulesdot()}{recursively\_query\_rulesdot()}}
{\footnotesize\ttfamily void snakemake\+\_\+unit\+\_\+tests\+::snakemake\+\_\+file\+::recursively\+\_\+query\+\_\+rulesdot (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{rule\+\_\+name,  }\item[{std\+::map$<$ std\+::string, bool $>$ $\ast$}]{target }\end{DoxyParamCaption}) const}



query rule for any \textquotesingle{}rules.\textquotesingle{} references, including those of dependencies pulled in by \textquotesingle{}rules.\textquotesingle{} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_a337c9312f49886fc34e4e33aa2c0dc10}\label{classsnakemake__unit__tests_1_1snakemake__file_a337c9312f49886fc34e4e33aa2c0dc10}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_a78a2f2c6e4529f15d1ec3dd7aa470dbe}\label{classsnakemake__unit__tests_1_1snakemake__file_a78a2f2c6e4529f15d1ec3dd7aa470dbe}} 
...
{\footnotesize\ttfamily unsigned snakemake\+\_\+unit\+\_\+tests\+::snakemake\+\_\+file\+::report\+\_\+single\+\_\+rule (\begin{DoxyParamCaption}\item[{const std\+::map$<$ std\+::string, bool $>$ \&}]{rule\+\_\+names,  }\item[{std\+::ostream \&}]{out }\end{DoxyParamCaption}) const}
...
\begin{DoxyParams}{Parameters}
{\em rule\+\_\+names} & string names of requested rules \\
\hline
{\em out} & open output stream to which to write data \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
how many target rules are present in this file 
\end{DoxyReturn}
\mbox{\Hypertarget{classsnakemake__unit__tests_1_1snakemake__file_ac58548d6095bdeba444c7c16a95e0a73}\label{classsnakemake__unit__tests_1_1snakemake__file_ac58548d6095bdeba444c7c16a95e0a73}} 
...
{\footnotesize\ttfamily bool snakemake\+\_\+unit\+\_\+tests\+::snakemake\+\_\+file\+::resolve\+\_\+with\+\_\+python (\begin{DoxyParamCaption}\item[{const boost\+::filesystem\+::path \&}]{workspace,  }\item[{const boost\+::filesystem\+::path \&}]{pipeline\+\_\+top\+\_\+dir,  }\item[{const boost\+::filesystem\+::path \&}]{pipeline\+\_\+run\+\_\+dir,  }\item[{bool}]{verbose,  }\item[{bool}]{disable\+\_\+resolution }\end{DoxyParamCaption})}
...
{\em workspace} & top level directory with added files and directories installed \\
\hline
{\em pipeline\+\_\+top\+\_\+dir} & top directory of pipeline installation \\
\hline
{\em pipeline\+\_\+run\+\_\+dir} & where the actual pipeline was initially run, relative to top level pipeline directory \\
\hline
{\em verbose} & whether to provide verbose logging output \\
\hline
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
whether the reporting terminated just after the first instance of an unresolved include directive. used to control recursive behavior.
\end{DoxyReturn}
